...
public class ConnectionFactory {
    ...
    // volatile garante que se essa instancia for modificada, ele vai receber a ultima versao o mais rapido possivel
    ...
    public static ConnectionFactory build() {
        ...
        } catch (IOException e) { //se não for permitida a leitura
            System.err.println("Não conseguimos ler o arquivo de propriedades com o nome:" + e.getMessage());
        } finally {
            if (Objects.nonNull(debugar) && debugar.equals("true")) //os dois tem que ser true
